...
//                    mStatus.setText(dataSnapshot.child("status").getValue().toString());
                    ...
                    mObjectTitle.setText(data.getStringExtra("ObjectTitle"));
                    mPlace.setText(data.getStringExtra("place"));
                    mCategory.setText(data.getStringExtra("category"));
                    mLostFound.setText(data.getStringExtra("happend"));
                     mStatus.setText(data.getStringExtra("status"));
                    Picasso.get().load(data.getStringExtra("img")).into(ViewPostImage);
